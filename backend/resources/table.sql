...
CREATE TABLE TOKENS (
  ...
  CONSTRAINT fk_user_tk FOREIGN KEY fk_user_token (id_user) REFERENCES USERS (id) ON DELETE CASCADE,
  CONSTRAINT fk_users_rtk FOREIGN KEY fk_user_role (role_user) REFERENCES ROLES (id) ON DELETE CASCADE
);